    ...
    <>
      <div className="flex flex-col border-r-4 border-gray-200 min-w-[15rem] w-1/6 p-5 h-[calc(100vh-3rem)]">
        ...
        <div className="py-3 flex flex-col gap-1">
          ...
          >
            <div className="flex items-center pl-1">
              <svg version="1.1" className="w-7 h-7" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enable-background="new 0 0 32 32" fill="#000000">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="5" y1="28" x2="5" y2="4"></line>
                  <circle fill="none" stroke-width="2" stroke-miterlimit="10" cx="16" cy="10" r="2"></circle>
                  <circle fill="none" stroke-width="2" stroke-miterlimit="10" cx="23" cy="16" r="2"></circle>
                  <circle fill="none" stroke-width="2" stroke-miterlimit="10" cx="11" cy="22" r="2"></circle>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="28" y1="16" x2="25" y2="16"></line>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="21" y1="16" x2="5" y2="16"></line>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="28" y1="10" x2="18" y2="10"></line>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="14" y1="10" x2="5" y2="10"></line>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="28" y1="22" x2="13" y2="22"></line>
                  <line fill="none" stroke-width="2" stroke-miterlimit="10" x1="9" y1="22" x2="5" y2="22"></line>
              </g></svg>
