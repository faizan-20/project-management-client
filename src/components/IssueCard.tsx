function IssueCard() {
  return (
    <div className="flex flex-col p-2 m-1 bg-white h-fit rounded-sm border border-slate-300 shadow-md cursor-pointer hover:bg-blue-100 transition-all duration-150">
